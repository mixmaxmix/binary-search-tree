...
class Tree {
  ...
  renderNodes(parentNodeObject, modifier = 1.5) {
    ...
    if (parentNodeObject.left !== null) {
      if (!document.getElementById(parentNodeObject.left.value)) {
        ...
        nodeContainer.style.left = nodeContainerStyles.left / modifier + "px";
      ...
      this.renderNodes(parentNodeObject.left, modifier * 1.5);
    }
    if (parentNodeObject.right !== null) {
      if (!document.getElementById(parentNodeObject.right.value)) {
        ...
        // nodeContainer.style.right = -modifier + "px";
        nodeContainer.style.right = nodeContainerStyles.right / modifier + "px";
      ...
      this.renderNodes(parentNodeObject.right, modifier * 1.5);
    }
  }
}
